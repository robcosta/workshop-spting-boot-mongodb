...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, Instant.parse("2018-06-20T19:53:07Z"),"Patiu viagem","Vou viajar para São Paulo. Abraços!", maria);
		Post p2 = new Post(null, Instant.parse("2018-06-25T19:53:07Z"),"Bom dia","Acordei feliz hoje", maria);
